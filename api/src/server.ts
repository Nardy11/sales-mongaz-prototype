...
const app = await createApi({ repository: persistent?.repository ?? fallbackRepository, sales, representative, telesales, orders, complaints, supervisor, allowedOrigin: process.env.WEB_ORIGIN ?? "http://localhost:5173" });
