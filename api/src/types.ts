...
export type Employee = { id: string; organizationId?: string; email: string; displayName: string; passwordHash: string; role: OperationalRole; teamId: string | null; active: boolean };
